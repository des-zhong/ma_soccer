...
def get_args():
    ...
    # Environment
    parser.add_argument("--scenario-name", type=str, default=str(a)+"vs_shuffule"+str(b), help="name of the scenario script")
    parser.add_argument("--max-episode-len", type=int, default=2000, help="maximum episode length")
    parser.add_argument("--max-iter", type=int, default=800, help="number of trial iters")
    parser.add_argument("--switch-iter", type=int, default=500, help="number of trial iters")
    ...
    parser.add_argument("--lr-critic", type=float, default=5e-6, help="learning rate of critic")
    ...
    parser.add_argument("--save-rate", type=int, default=20000,
                        help="save model once every time this many episodes are completed")
    parser.add_argument("--model-dir", type=str, default="",
                        help="directory in which training state and model are loaded")

    # per params
    parser.add_argument("--use-per", type=bool, default=True, help="whether to use Prioritized Experience Replay")
...
def get_env_arg():
    ...
    parser.add_argument("--state-term", type=int, default=1,
